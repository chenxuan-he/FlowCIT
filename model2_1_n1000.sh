...
nohup python -u model.py --model=2 --sim_type=1 --alpha=.00 --n=1000 --p=50 --q=50 --d=100 --par_task=5 --gpu=1 --cpu=000-210 --nsim=200 --hidden_num=20 --n_iter=800 --FlowCIT=0 --CDC=0 --FCIT=1 --CCIT=1 &> model2_s1_a00.txt &
