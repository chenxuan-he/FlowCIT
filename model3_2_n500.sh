...
nohup python -u model.py --model=3 --sim_type=2 --alpha=.00 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=0 --cpu=000-040 --nsim=200 --hidden_num=32 &> model3_s2_a00.txt &
nohup python -u model.py --model=3 --sim_type=2 --alpha=.10 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=4 --cpu=040-080 --nsim=200 --hidden_num=32 &> model3_s2_a10.txt &
nohup python -u model.py --model=3 --sim_type=2 --alpha=.20 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=5 --cpu=080-120 --nsim=200 --hidden_num=32 &> model3_s2_a20.txt &
nohup python -u model.py --model=3 --sim_type=2 --alpha=.30 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=6 --cpu=120-160 --nsim=200 --hidden_num=32 &> model3_s2_a30.txt &
nohup python -u model.py --model=3 --sim_type=2 --alpha=.40 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=7 --cpu=160-200 --nsim=200 --hidden_num=32 &> model3_s2_a40.txt &
...
nohup python -u model.py --model=3 --sim_type=2 --alpha=.00 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=0 --cpu=100-200 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 &> model3_s2_a00.txt &
nohup python -u model.py --model=3 --sim_type=2 --alpha=.10 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=1 --cpu=100-200 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 &> model3_s2_a10.txt &
nohup python -u model.py --model=3 --sim_type=2 --alpha=.20 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=2 --cpu=100-200 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 &> model3_s2_a20.txt &
nohup python -u model.py --model=3 --sim_type=2 --alpha=.30 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=6 --cpu=100-200 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 &> model3_s2_a30.txt &
nohup python -u model.py --model=3 --sim_type=2 --alpha=.40 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=7 --cpu=100-200 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 &> model3_s2_a40.txt &
python model_result.py --model=3 --sim_type=2 --alphas="0.0,0.1,0.2,0.3,0.4" --n=500 --p=1 --q=1 --d=2
