...
nohup python -u model.py --model=3 --CCIT=0 --sim_type=3 --alpha=.00 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=3 --cpu=000-040 --nsim=200 --hidden_num=32 &> model3_s3_a00.txt &
nohup python -u model.py --model=3 --CCIT=0 --sim_type=3 --alpha=.10 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=4 --cpu=040-080 --nsim=200 --hidden_num=32 &> model3_s3_a10.txt &
nohup python -u model.py --model=3 --CCIT=0 --sim_type=3 --alpha=.20 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=5 --cpu=080-120 --nsim=200 --hidden_num=32 &> model3_s3_a20.txt &
nohup python -u model.py --model=3 --CCIT=0 --sim_type=3 --alpha=.30 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=6 --cpu=120-160 --nsim=200 --hidden_num=32 &> model3_s3_a30.txt &
nohup python -u model.py --model=3 --CCIT=0 --sim_type=3 --alpha=.40 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=7 --cpu=160-200 --nsim=200 --hidden_num=32 &> model3_s3_a40.txt 

nohup python -u model.py --model=3 --FlowCIT=0 --CDC=0 --FCIT=0 --sim_type=3 --alpha=.00 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=3 --cpu=000-040 --nsim=200 --hidden_num=32 &> model3_CCIT_s3_a00.txt &
nohup python -u model.py --model=3 --FlowCIT=0 --CDC=0 --FCIT=0 --sim_type=3 --alpha=.10 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=4 --cpu=040-080 --nsim=200 --hidden_num=32 &> model3_CCIT_s3_a10.txt &
nohup python -u model.py --model=3 --FlowCIT=0 --CDC=0 --FCIT=0 --sim_type=3 --alpha=.20 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=5 --cpu=080-120 --nsim=200 --hidden_num=32 &> model3_CCIT_s3_a20.txt &
nohup python -u model.py --model=3 --FlowCIT=0 --CDC=0 --FCIT=0 --sim_type=3 --alpha=.30 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=6 --cpu=120-160 --nsim=200 --hidden_num=32 &> model3_CCIT_s3_a30.txt &
nohup python -u model.py --model=3 --FlowCIT=0 --CDC=0 --FCIT=0 --sim_type=3 --alpha=.40 --n=500 --p=1 --q=1 --d=2 --par_task=5 --gpu=7 --cpu=160-200 --nsim=200 --hidden_num=32 &> model3_CCIT_s3_a40.txt 
