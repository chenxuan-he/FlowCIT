# First: generate data
python model_generate_data.py --model=1 --sim_type=4 --alpha=.00 --nsim=200 --d=3 --p=3 --q=3 --n=500
python model_generate_data.py --model=1 --sim_type=4 --alpha=.05 --nsim=200 --d=3 --p=3 --q=3 --n=500
python model_generate_data.py --model=1 --sim_type=4 --alpha=.10 --nsim=200 --d=3 --p=3 --q=3 --n=500
python model_generate_data.py --model=1 --sim_type=4 --alpha=.15 --nsim=200 --d=3 --p=3 --q=3 --n=500
python model_generate_data.py --model=1 --sim_type=4 --alpha=.20 --nsim=200 --d=3 --p=3 --q=3 --n=500
