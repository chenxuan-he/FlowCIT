...
nohup python -u model_GCIT.py --model=1 --sim_type=3 --alpha=.00 --n=500 --p=3 --q=3 --d=3 --par_task=50 --cpu=000-040 --nsim=200 --test_prop=.01 &> model1_s3_GCIT_a00.txt &
nohup python -u model_GCIT.py --model=1 --sim_type=3 --alpha=.05 --n=500 --p=3 --q=3 --d=3 --par_task=50 --cpu=040-080 --nsim=200 --test_prop=.01 &> model1_s3_GCIT_a05.txt &
nohup python -u model_GCIT.py --model=1 --sim_type=3 --alpha=.10 --n=500 --p=3 --q=3 --d=3 --par_task=50 --cpu=080-120 --nsim=200 --test_prop=.01 &> model1_s3_GCIT_a10.txt &
