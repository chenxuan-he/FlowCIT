...
nohup python -u model.py --gpu=1 --cpu=80-130 --model=2 --sim_type=3 --p=50 --q=50 --d=100 --n=1000 --alpha=-0.4 --par_task=10 --nsim=100 --hidden_num=32 &> model2_n1000_s3_-4.txt & 
