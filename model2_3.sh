...
nohup python -u model.py --gpu=6 --cpu=140-190 --model=2 --sim_type=3 --p=50 --q=50 --d=100 --n=1000 --alpha=-0.8 --par_task=5 --nsim=100 --hidden_num=32 &> model2_n1000_s3_-8.txt & 
nohup python -u model.py --gpu=7 --cpu=170-220 --model=2 --sim_type=3 --p=50 --q=50 --d=100 --n=1000 --alpha=0.8 --par_task=5 --nsim=100 --hidden_num=32 &> model2_n1000_s3_8.txt &
