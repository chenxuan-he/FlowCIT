...
nohup python -u model.py --gpu=4 --cpu=40-90 --model=2 --sim_type=3 --p=50 --q=50 --d=100 --n=1000 --alpha=0.4 --par_task=10 --nsim=100 --hidden_num=32 &> model2_n1000_s3_4.txt & 
...
nohup python -u model.py --gpu=6 --cpu=120-170 --model=2 --sim_type=3 --p=50 --q=50 --d=100 --n=1000 --alpha=0.8 --par_task=10 --nsim=100 --hidden_num=32 &> model2_n1000_s3_8.txt &
