...
def dgcit(x, y, z, seed=0, batch_size=64, n_iter=1000, train_writer=None, current_iters=0, M=500, k=2, b=30, j=1000):
    ...
    gx_optimiser = tf.keras.optimizers.Adam(lr, beta_1=0.5, clipvalue=gen_clipping_val)
    dx_optimiser = tf.keras.optimizers.Adam(lr, beta_1=0.5, clipvalue=w_clipping_val)
    gy_optimiser = tf.keras.optimizers.Adam(lr, beta_1=0.5, clipvalue=gen_clipping_val)
    dy_optimiser = tf.keras.optimizers.Adam(lr, beta_1=0.5, clipvalue=w_clipping_val)
