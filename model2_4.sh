...
nohup python -u model.py --gpu=2 --cpu=0-50 --model=2 --sim_type=4 --p=50 --q=50 --d=100 --n=1000 --alpha=0 --par_task=5 --nsim=100 --hidden_num=32 &> model2_n1000_s4_0.txt &
nohup python -u model.py --gpu=3 --cpu=40-90 --model=2 --sim_type=4 --p=50 --q=50 --d=100 --n=1000 --alpha=0.4 --par_task=5 --nsim=100 --hidden_num=32 &> model2_n1000_s4_4.txt & 
