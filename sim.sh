...
nohup python -u sim.py --gpu=3 --cpu=40-60 --sim_type=1 --p=3 --q=3 --d=100 --n=1000 --alpha=.2 --par_task=5 --nsim=100 &> sim_n1000_s1_d100_2.txt &

# running on 111
# nohup python -u sim.py --gpu=5 --cpu=0-50 --sim_type=1 --p=3 --q=3 --d=100 --n=1000 --alpha=0 --par_task=5 --nsim=100 --hidden_num=128 &> sim_n1000_s1_d100_0.txt &
# nohup python -u sim.py --gpu=6 --cpu=50-100 --sim_type=1 --p=3 --q=3 --d=100 --n=1000 --alpha=.2 --par_task=5 --nsim=100 --hidden_num=128 &> sim_n1000_s1_d100_2.txt &
# nohup python -u sim.py --gpu=7 --cpu=100-150 --sim_type=1 --p=3 --q=3 --d=100 --n=1000 --alpha=.4 --par_task=5 --nsim=100 --hidden_num=128 &> sim_n1000_s1_d100_4.txt &
# nohup python -u sim.py --gpu=0 --cpu=150-200 --sim_type=1 --p=3 --q=3 --d=100 --n=1000 --alpha=0 --par_task=5 --nsim=100 --hidden_num=32 &> sim_n1000_s1_d100_0_32.txt &


nohup python -u sim.py --gpu=5 --cpu=0-50 --sim_type=1 --p=10 --q=10 --d=50 --n=1000 --alpha=0 --par_task=5 --nsim=100 --hidden_num=128 &> sim_n1000_s1_d50_0.txt &
nohup python -u sim.py --gpu=6 --cpu=50-100 --sim_type=1 --p=10 --q=10 --d=50 --n=1000 --alpha=.2 --par_task=5 --nsim=100 --hidden_num=128 &> sim_n1000_s1_d50_2.txt &
nohup python -u sim.py --gpu=7 --cpu=100-150 --sim_type=1 --p=10 --q=10 --d=50 --n=1000 --alpha=.4 --par_task=5 --nsim=100 --hidden_num=128 &> sim_n1000_s1_d50_4.txt &
nohup python -u sim.py --gpu=4 --cpu=150-200 --sim_type=1 --p=10 --q=10 --d=50 --n=1000 --alpha=0 --par_task=5 --nsim=100 --hidden_num=32 &> sim_n1000_s1_d50_0_32.txt &
