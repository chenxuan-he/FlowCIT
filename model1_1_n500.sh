...
nohup python model_generate_data.py --model=1 --sim_type=1 --alpha=.05 --nsim=200 --d=3 --p=3 --q=3 --n=500
nohup python model_generate_data.py --model=1 --sim_type=1 --alpha=.10 --nsim=200 --d=3 --p=3 --q=3 --n=500
nohup python model_generate_data.py --model=1 --sim_type=1 --alpha=.15 --nsim=200 --d=3 --p=3 --q=3 --n=500
nohup python model_generate_data.py --model=1 --sim_type=1 --alpha=.20 --nsim=200 --d=3 --p=3 --q=3 --n=500
...
nohup python -u model_GCIT.py --model=1 --sim_type=1 --alpha=.00 --n=500 --p=3 --q=3 --d=3 --par_task=50 --cpu=000-040 --nsim=200 --test_prop=.02 &> model1_s1_GCIT_a00.txt &
nohup python -u model_GCIT.py --model=1 --sim_type=1 --alpha=.05 --n=500 --p=3 --q=3 --d=3 --par_task=50 --cpu=040-080 --nsim=200 --test_prop=.02 &> model1_s1_GCIT_a05.txt &
nohup python -u model_GCIT.py --model=1 --sim_type=1 --alpha=.10 --n=500 --p=3 --q=3 --d=3 --par_task=50 --cpu=080-120 --nsim=200 --test_prop=.02 &> model1_s1_GCIT_a10.txt &
nohup python -u model_GCIT.py --model=1 --sim_type=1 --alpha=.15 --n=500 --p=3 --q=3 --d=3 --par_task=50 --cpu=120-160 --nsim=200 --test_prop=.02 &> model1_s1_GCIT_a15.txt &
nohup python -u model_GCIT.py --model=1 --sim_type=1 --alpha=.20 --n=500 --p=3 --q=3 --d=3 --par_task=50 --cpu=160-200 --nsim=200 --test_prop=.02 &> model1_s1_GCIT_a20.txt &

python model_result.py --model=1 --sim_type=1 --alphas="0.0,0.05,0.1,0.15,0.2" --n=500 --p=3 --q=3 --d=3 --GCIT=True --GCIT_test_prop=.02
