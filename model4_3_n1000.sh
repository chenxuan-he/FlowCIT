...
nohup python -u model.py --model=4 --sim_type=3 --FlowCIT=0 --FCIT=1 --CDC=0 --CCIT=1 --alpha=.00 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu="" --cpu=040-255 --nsim=200 &> model4_CCIT_s3_a00.txt &
nohup python -u model.py --model=4 --sim_type=3 --FlowCIT=0 --FCIT=1 --CDC=0 --CCIT=1 --alpha=.10 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu="" --cpu=040-255 --nsim=200 &> model4_CCIT_s3_a10.txt &
nohup python -u model.py --model=4 --sim_type=3 --FlowCIT=0 --FCIT=1 --CDC=0 --CCIT=1 --alpha=.20 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu="" --cpu=040-255 --nsim=200 &> model4_CCIT_s3_a20.txt &
nohup python -u model.py --model=4 --sim_type=3 --FlowCIT=0 --FCIT=1 --CDC=0 --CCIT=1 --alpha=.30 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu="" --cpu=040-255 --nsim=200 &> model4_CCIT_s3_a30.txt &
nohup python -u model.py --model=4 --sim_type=3 --FlowCIT=0 --FCIT=1 --CDC=0 --CCIT=1 --alpha=.40 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu="" --cpu=040-255 --nsim=200 &> model4_CCIT_s3_a40.txt &
