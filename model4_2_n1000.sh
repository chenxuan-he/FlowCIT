...
nohup python -u model.py --model=4 --sim_type=2 --FlowCIT=1 --FCIT=0 --CDC=0 --CCIT=0 --hidden_num=8 --alpha=.00 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=0 --cpu=160-240 --nsim=200 &> model4_s2_a00.txt &
nohup python -u model.py --model=4 --sim_type=2 --FlowCIT=1 --FCIT=0 --CDC=0 --CCIT=0 --hidden_num=8 --alpha=.10 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=1 --cpu=160-240 --nsim=200 &> model4_s2_a10.txt &
nohup python -u model.py --model=4 --sim_type=2 --FlowCIT=1 --FCIT=0 --CDC=0 --CCIT=0 --hidden_num=8 --alpha=.20 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=2 --cpu=160-240 --nsim=200 &> model4_s2_a20.txt &
