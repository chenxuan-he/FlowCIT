...
nohup python -u model.py --model=4 --sim_type=2 --FlowCIT=1 --FCIT=1 --CDC=0 --CCIT=0 --sim_type=2 --alpha=.00 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=1 --cpu=000-040 --nsim=200 &> model4_s2_a00.txt &
nohup python -u model.py --model=4 --sim_type=2 --FlowCIT=1 --FCIT=1 --CDC=0 --CCIT=0 --sim_type=2 --alpha=.10 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=2 --cpu=040-080 --nsim=200 &> model4_s2_a10.txt &
nohup python -u model.py --model=4 --sim_type=2 --FlowCIT=1 --FCIT=1 --CDC=0 --CCIT=0 --sim_type=2 --alpha=.20 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=3 --cpu=080-120 --nsim=200 &> model4_s2_a20.txt &
nohup python -u model.py --model=4 --sim_type=2 --FlowCIT=1 --FCIT=1 --CDC=0 --CCIT=0 --sim_type=2 --alpha=.30 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=4 --cpu=120-160 --nsim=200 &> model4_s2_a30.txt &
nohup python -u model.py --model=4 --sim_type=2 --FlowCIT=1 --FCIT=1 --CDC=0 --CCIT=0 --sim_type=2 --alpha=.40 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=5 --cpu=160-200 --nsim=200 &> model4_s2_a40.txt &
...
# Generate plots
python model_plot.py --model=4 --sim_type=2 --n=1000 --alphas="0.0,0.1,0.2,0.3,0.4" --legend=1