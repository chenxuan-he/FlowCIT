...
nohup python -u model.py --model=4 --sim_type=2 --alpha=.0 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=0 --cpu=000-080 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 --hidden_num=16 &> model4_s2_a00.txt &
nohup python -u model.py --model=4 --sim_type=2 --alpha=.1 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=1 --cpu=000-080 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 --hidden_num=16 &> model4_s2_a10.txt &
nohup python -u model.py --model=4 --sim_type=2 --alpha=.2 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=2 --cpu=000-080 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 --hidden_num=16 &> model4_s2_a20.txt &
nohup python -u model.py --model=4 --sim_type=2 --alpha=.3 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=3 --cpu=000-080 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 --hidden_num=16 &> model4_s2_a30.txt &
nohup python -u model.py --model=4 --sim_type=2 --alpha=.4 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=3 --cpu=000-080 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 --hidden_num=16 &> model4_s2_a40.txt &
