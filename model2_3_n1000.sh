...
nohup python -u model.py --model=2 --sim_type=3 --alpha=.00 --n=1000 --p=50 --q=50 --d=100 --par_task=5 --gpu=3 --cpu=000-210 --nsim=200 --FlowCIT=1 --CDC=0 --FCIT=0 --CCIT=0 --hidden_num=16 &> model2_s3_a00_neuron16.txt &
nohup python -u model.py --model=2 --sim_type=3 --alpha=.00 --n=1000 --p=50 --q=50 --d=100 --par_task=5 --gpu=1 --cpu=000-210 --nsim=200 --FlowCIT=0 --CDC=0 --FCIT=1 --CCIT=1 --hidden_num=16 &> model2_s3_a00.txt &
nohup python -u model.py --model=2 --sim_type=3 --alpha=.20 --n=1000 --p=50 --q=50 --d=100 --par_task=5 --gpu=2 --cpu=040-080 --nsim=200 --FlowCIT=1 --CDC=0 --FCIT=1 --CCIT=1 --hidden_num=16 &> model2_s3_a20.txt &
nohup python -u model.py --model=2 --sim_type=3 --alpha=.40 --n=1000 --p=50 --q=50 --d=100 --par_task=5 --gpu=5 --cpu=080-120 --nsim=200 --FlowCIT=1 --CDC=0 --FCIT=1 --CCIT=1 --hidden_num=16 &> model2_s3_a40.txt &
nohup python -u model.py --model=2 --sim_type=3 --alpha=.60 --n=1000 --p=50 --q=50 --d=100 --par_task=5 --gpu=6 --cpu=120-160 --nsim=200 --FlowCIT=1 --CDC=0 --FCIT=1 --CCIT=1 --hidden_num=16 &> model2_s3_a60.txt &
...
# # add the FlowCIT-IPC
nohup python -u model.py --model=2 --sim_type=3 --alpha=.0 --n=1000 --p=50 --q=50 --d=100 --par_task=5 --gpu=0 --cpu=000-080 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 --hidden_num=10 &> model2_s3_a00.txt &
nohup python -u model.py --model=2 --sim_type=3 --alpha=.2 --n=1000 --p=50 --q=50 --d=100 --par_task=5 --gpu=1 --cpu=000-080 --nsim=200 --CCIT=0 --CDC=0 --FCIT=0 --FlowCIT=1 --FlowCIT_method="IPC" --FlowCIT_permutation=0 --hidden_num=10 &> model2_s3_a20.txt &
