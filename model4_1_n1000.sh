...
nohup python -u model.py --model=4 --sim_type=1 --FlowCIT=1 --FCIT=0 --CDC=0 --CCIT=0 --hidden_num=8 --alpha=.00 --n=1000 --p=5 --q=5 --d=50 --par_task=5 --gpu=0 --cpu=040-120 --nsim=200 &> model4_s1_a00.txt &
